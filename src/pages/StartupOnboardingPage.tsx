...
const RightPanels: Record<number, React.ReactElement> = {
  1: (
    <div className="flex flex-col gap-7">
      <div>
        <p className="mb-2 text-[13px] font-bold uppercase tracking-widest text-blue-500/80">
          Why this matters
        </p>
        <p className="text-[17px] leading-relaxed text-[#29283a]">
          Your startup's sector and current stage determine which seed funds,
          incubation programmes, and government grants you can access.
        </p>
      </div>
      <div className="space-y-4">
        {[
          {
            icon: "rocket_launch",
            text: "Stage unlocks SISFS, AIM, and incubator grants",
          },
          {
            icon: "category",
            text: "Sector maps to 150+ startup-specific schemes",
          },
          {
            icon: "verified",
            text: "Constitution needed for DPIIT recognition",
          },
        ].map((item) => (
          <div key={item.text} className="flex items-start gap-3">
            ...
            <p className="text-[15px] leading-snug text-[#29283a]">
              {item.text}
            </p>
          </div>
        ))}
  ...
  2: (
    <div className="flex flex-col gap-7">
      <div>
        ...
        <p className="text-[17px] leading-relaxed text-[#29283a]">
          States like Karnataka, Maharashtra, and Telangana have dedicated
          startup missions with exclusive funding and mentorship programmes.
        </p>
      </div>
      <div className="rounded-2xl border border-blue-200 bg-blue-50 p-5">
        <p className="mb-2 text-[13px] font-bold text-blue-700">Startup Hubs</p>
        <div className="space-y-1.5 text-[14px] text-[#29283a]">
          {[
            "Bengaluru — Electronics City, Koramangala",
            "Mumbai — BKC, Powai",
  ...
  3: (
    <div className="flex flex-col gap-7">
      <div>
        ...
        <p className="text-[17px] leading-relaxed text-[#29283a]">
          Even startups can qualify as Micro or Small enterprises — unlocking
          CGTMSE collateral-free loans and MSME procurement benefits.
        </p>
      </div>
      <div className="space-y-3">
        {[
          ...
          <div
            key={row.cat}
            className="flex items-center justify-between rounded-lg border border-[#dde1ec] bg-white px-4 py-2.5 text-[14px]"
          >
            <span className={`font-bold ${row.color}`}>{row.cat}</span>
            <span className="text-[#6f7586]">
              Invest {row.inv} · Turnover {row.turn}
            </span>
          </div>
        ))}
      </div>
  ...
  4: (
    <div className="flex flex-col gap-7">
      <div>
        ...
        <p className="text-[17px] leading-relaxed text-[#29283a]">
          Your funding stage and investor type help us suggest the right next
          round — angels, VCs, or government grants like BIRAC and DST-NIDHI.
        </p>
      </div>
      <div className="space-y-3">
        {[
          {
            ...
            note: "Up to ₹20 Lakh — Idea & MVP stage",
          },
          {
            scheme: "BIRAC BIG Grant",
            note: "Up to ₹50 Lakh — Biotech startups",
          },
          {
            scheme: "DST NIDHI PRAYAS",
            note: "Up to ₹10 Lakh — Prototype building",
          },
        ].map((s) => (
          <div
            key={s.scheme}
  ...
  5: (
    <div className="flex flex-col gap-7">
      <div>
        ...
        <p className="text-[17px] leading-relaxed text-[#29283a]">
          DPIIT-recognised startups get tax exemptions under Section 80-IAC,
          fast-track patent filing, and access to 40+ exclusive government
          benefits.
        </p>
      </div>
      <div className="rounded-2xl border border-blue-200 bg-blue-50 p-5">
        <p className="mb-2 text-[13px] font-bold text-blue-700">
          Not yet recognised?
        </p>
        <p className="text-[14px] leading-relaxed text-[#29283a]">
          We'll guide you through the DPIIT application on startupindia.gov.in —
          it takes under 2 hours and is completely free.
        </p>
      </div>
    </div>
  ),
  6: (
    <div className="flex flex-col gap-7">
      <div>
        ...
        <p className="text-[17px] leading-relaxed text-[#29283a]">
          Women-led, SC/ST, and first-generation entrepreneur startups get
          priority access in government accelerators and grant programmes.
        </p>
      </div>
      <div className="space-y-3">
        {[
          {
            scheme: "WEP — Women Entrepreneurship",
            note: "Mentorship + funding for women founders",
          },
          {
            scheme: "NAARI — Nasscom",
            note: "Tech accelerator for women-led startups",
          },
...
const StartupOnboardingPage = (): React.ReactElement => {
  ...
  const msmeCategory = computeMsmeCategory(
    form.investment_plant_machinery,
    ...
    >
        ...
        <>
          ...
          <div className="flex max-w-[620px] flex-col gap-7">
            <Field label="Startup / Entity Name" htmlFor="business_name">
              <TextInput
                id="business_name"
                placeholder="e.g. FinFlow Technologies Pvt. Ltd."
            ...
            <Field label="Startup Description" htmlFor="startup_description">
              <TextArea
                ...
                placeholder="Briefly describe what your startup does, the problem it solves, and your target market..."
                value={form.startup_description}
                onChange={(e) => set("startup_description", e.target.value)}
              />
            </Field>
          ...
          <div className="flex max-w-[620px] flex-col gap-7">
            ...
            >
              <SelectInput
                ...
                onChange={(e) => set("annual_turnover_range", e.target.value)}
              />
            </Field>
            <Field
            ...
            >
              <SelectInput
                ...
                value={form.investment_plant_machinery}
                onChange={(e) =>
                  set("investment_plant_machinery", e.target.value)
                }
              />
            </Field>
            {(form.annual_turnover_range ||
            ...
            <Field label="GST Filing Status" htmlFor="gst_status">
              <SelectInput
                ...
                onChange={(e) => set("gst_status", e.target.value)}
              />
            </Field>
            <Field
              label="Production / Service Start Date"
              htmlFor="production_start"
            >
              <TextInput
                id="production_start"
                type="date"
                value={form.production_start}
                onChange={(e) => set("production_start", e.target.value)}
              />
            </Field>
            <div className="grid grid-cols-3 gap-4">
              <Field label="Total Employees" htmlFor="total_employees">
                <NumberInput
                  ...
                  onChange={(e) => set("total_employees", e.target.value)}
                />
              </Field>
              <Field label="Male Employees" htmlFor="male_employees">
                <NumberInput
                  id="male_employees"
                  placeholder="0"
                  value={form.male_employees}
                  onChange={(e) => set("male_employees", e.target.value)}
                />
              </Field>
              <Field label="Female Employees" htmlFor="female_employees">
                <NumberInput
                  ...
                  onChange={(e) => set("female_employees", e.target.value)}
                />
              </Field>
            </div>
            <div className="flex gap-4 pt-2">
      ...
      {step === 4 && (
        <>
          ...
          <div className="flex max-w-[620px] flex-col gap-7">
            <Field
              label="Investment Raised (Total)"
              htmlFor="investment_raised"
            >
              <SelectInput
                id="investment_raised"
                placeholder="Select raised amount"
                options={INVESTMENT_RAISED_OPTIONS}
                value={form.investment_raised}
                onChange={(e) => set("investment_raised", e.target.value)}
              />
            </Field>
            ...
            <Field label="Investors / Partners (optional)" htmlFor="investors">
              <TextInput
                id="investors"
                placeholder="e.g. Sequoia India, Y Combinator, Accel…"
            ...
            <Field label="Number of Co-founders" htmlFor="co_founders">
              <NumberInput
                ...
                min={0}
                max={20}
                value={form.co_founders}
                onChange={(e) => set("co_founders", e.target.value)}
              />
            </Field>
            <div className="flex gap-4 pt-2">
              <BluePrimaryAction onClick={next}>
      ...
      {step === 5 && (
        <>
          ...
          <div className="flex max-w-[680px] flex-col gap-7">
            <Field
              label="Existing Registrations (select all that apply)"
              htmlFor="existing_registrations"
            >
              <CheckboxGroup
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              >
                <TextInput
                  id="udyam_number"
                  placeholder="UDYAM-MH-00-0000001"
            ...
            <Field
              label="DPIIT Certificate Number (optional)"
              htmlFor="dpiit_number"
            >
              <TextInput
                id="dpiit_number"
            ...
            <Field label="Pending Legal Notices" htmlFor="pending_notices">
              <SelectInput
                ...
                value={form.pending_notices}
                onChange={(e) => set("pending_notices", e.target.value)}
              />
            </Field>
            <div className="flex gap-4 pt-2">
              <BluePrimaryAction onClick={next}>
      ...
      {step === 6 && (
        <>
          ...
          <div className="flex max-w-[620px] flex-col gap-7">
            <div className="grid grid-cols-2 gap-5">
              <Field label="Founder Gender" htmlFor="owner_gender">
                <SelectInput
                  ...
                  onChange={(e) => set("owner_gender", e.target.value)}
                />
              </Field>
              <Field label="Founder Age Group" htmlFor="owner_age_group">
                <SelectInput
                  ...
                  value={form.owner_age_group}
                  onChange={(e) => set("owner_age_group", e.target.value)}
                />
              </Field>
            </div>
            <div className="grid grid-cols-2 gap-5">
            ...
            <Field
              label="Government Schemes Already Known (optional)"
              htmlFor="known_schemes"
            >
              <TextArea
                id="known_schemes"
                placeholder="e.g. Startup India Seed Fund, BIRAC BIG, DST NIDHI..."
                value={form.known_schemes}
                onChange={(e) => set("known_schemes", e.target.value)}
              />
            </Field>
            <div className="flex gap-4 pt-2">
              <BluePrimaryAction onClick={next}>
