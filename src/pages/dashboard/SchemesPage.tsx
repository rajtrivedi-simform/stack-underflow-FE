...
const DOC_TYPES: DocTypeCard[] = [
  {
    ...
    description:
      "Formal letter to apply for a specific government scheme. AI pre-fills your details with high precision.",
  ...
  },
  {
    ...
    description:
      "Prioritised roadmap to fix compliance gaps based on your latest check. Generated automatically.",
  ...
  },
  {
    ...
    description:
      "Comprehensive report summarising your profile, matched schemes, and growth recommendations.",
    metaIcon: "person",
      ...
      <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant/40 p-4 flex items-center gap-4 shadow-sm">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-on-surface-variant">
            ...
            application is highly recommended. Our AI suggests drafting this
            first.
          </p>
        </div>
        <button
          ...
          className="shrink-0 h-9 px-4 bg-blue-500 hover:bg-blue-600 text-white text-xs font-semibold rounded-xl transition-colors"
        >
          Draft Now
        </button>
      </div>
