    ...
    <div className="p-md min-h-full pb-8">
      ...
      <div className="flex items-center justify-between mb-md">
        <div className="flex items-center gap-sm">
          ...
          <h1 className="font-title-md text-title-md font-bold text-on-surface">Account Settings</h1>
        </div>
        <div className="flex items-center gap-sm">
      ...
      <div className="max-w-[600px]">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <h2 className="text-base font-bold text-on-surface">John Smith</h2>
        ...
        <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant/40 shadow-sm p-5 mb-4">
          <h3 className="text-sm font-bold text-on-surface mb-4">Update Credentials</h3>

          <div className="grid grid-cols-2 gap-4 mb-4">
            {/* Email */}
            <div>
              <p className="text-xs text-on-surface-variant mb-1.5">Email Address</p>
              <div className="flex items-center justify-between h-10 px-sm rounded-xl border border-outline-variant/50 bg-surface-container-low">
                {editingEmail ? (
                  ...
                  <span className="flex-1 text-xs text-on-surface truncate">{email}</span>
                )}
                <button
                  type="button"
            ...
            {/* Phone */}
            <div>
              <p className="text-xs text-on-surface-variant mb-1.5">Phone Number</p>
              <div className="flex items-center justify-between h-10 px-sm rounded-xl border border-outline-variant/50 bg-surface-container-low">
                {editingPhone ? (
                  <input
                    type="tel"
                  ...
                  <span className="flex-1 text-xs text-on-surface truncate">{phone}</span>
                )}
                <button
                  type="button"
          ...
          <div>
            ...
            <div className="flex items-center justify-between h-10 px-sm rounded-xl border border-outline-variant/50 bg-surface-container-low">
              <span className="text-sm text-on-surface tracking-[0.2em]">••••••••••••</span>
        ...
        <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant/40 shadow-sm p-5 mb-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-[10px] font-bold text-on-surface-variant/50 uppercase tracking-wider">Coming Soon</span>
          </div>
          ...
          <div className="flex items-center gap-3 py-2">
            ...
            <div>
              <p className="text-sm font-semibold text-on-surface">Notification Settings</p>
        ...
        <div className="rounded-2xl border border-red-200 overflow-hidden mb-md">
          ...
          <div className="bg-surface-container-lowest p-5">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-bold text-on-surface mb-1">Delete Account</p>
                <p className="text-xs text-on-surface-variant leading-relaxed">
                  Permanently deletes your profile and all data after 90 days.{' '}
                  <span className="text-error font-semibold">This action is irreversible</span>{' '}
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-md">
          <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant/40 shadow-xl p-6 max-w-sm w-full animate-in fade-in zoom-in-95 duration-200">
            ...
            <h3 className="text-base font-bold text-on-surface text-center mb-2">Delete Account?</h3>
            <p className="text-xs text-on-surface-variant text-center leading-relaxed mb-5">
              This will permanently delete your account and all associated data after 90 days. This action cannot be undone.
            </p>
