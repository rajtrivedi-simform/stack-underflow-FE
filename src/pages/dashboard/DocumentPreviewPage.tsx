...
const REQUIRED_FIELDS: RequiredField[] = [
  ...
  },
  {
    ...
    context:
      "...wish to apply for a term loan of [LOAN AMOUNT REQUESTED] for the purpose of business expansion.",
  },
  {
    id: "companyRegNo",
    ...
    context:
      "Our company, registered under CIN [COMPANY REGISTRATION NUMBER], is engaged in...",
  },
];
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
        ...
        <div className="flex items-center gap-3 px-5 pb-4">
          ...
          <button
            ...
            className="flex items-center gap-1 h-10 px-5 bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold rounded-xl transition-colors ml-auto"
          >
  ...
  return (
    <>
      <div className="flex flex-col h-full">
        ...
        <div className="flex items-center justify-between px-md py-3 border-b border-outline-variant/30 bg-surface-container-lowest shrink-0">
          ...
          <div className="flex items-center gap-sm">
            <div className="relative">
              <span className="material-symbols-outlined text-[20px] text-on-surface-variant/50 absolute left-2 top-1/2 -translate-y-1/2">
                search
              </span>
              <input
        ...
        {/* AI Banner */}
        <div className="flex items-center justify-between bg-blue-50 border-b border-blue-200 px-md py-2.5 shrink-0">
          <div className="flex items-center gap-2">
            ...
            <p className="text-xs text-blue-800">
              ...
              <span className="font-semibold text-blue-600">
                {totalFields - filledCount} fields need your input
              </span>
            </p>
          </div>
          <button
            type="button"
            onClick={() =>
              openFillAt(filledCount < totalFields ? filledCount : 0)
            }
            className="h-7 px-3 bg-blue-500 hover:bg-blue-600 text-white text-xs font-semibold rounded-lg transition-colors"
          >
            Jump to Next
          </button>
        </div>
            ...
            <div className="relative space-y-5 text-sm text-on-surface">
              ...
              <div>
                ...
                <p className="font-medium leading-snug">
                  Application for Financial Assistance under the Credit
              ...
              {/* To */}
              <div>
                <p className="text-[10px] font-bold text-on-surface/40 uppercase tracking-widest mb-2">
                  To,
                </p>
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  ...
                  <span className="font-semibold">VyaparSetu AI</span>, wish to
                  apply for a term loan of{" "}
                  <RequiredChip
                    label="Loan Amount Requested"
                  ...
                  <span className="text-primary">
                    Our current compliance health score is{" "}
                  </span>
                  <span className="font-bold text-primary">84%</span>
                  <span className="text-primary">
                    , and we meet all eligibility criteria for the scheme.
                  </span>{" "}
                  We have consistently maintained a high credit performance and
                  are looking to scale our logistics operations across the
                  domestic circuit.
                </p>
              </div>
              ...
              <div>
                <p className="leading-relaxed">
                  ...
                  />{" "}
                  is engaged in providing technology-enabled logistics services
                  with a proven track record of timely delivery and compliance.
                </p>
              </div>

              <p className="leading-relaxed text-on-surface/60 italic">
                [Declaration clause, enclosures, and signatory section
                follow...]
              </p>
            </div>
          </div>
